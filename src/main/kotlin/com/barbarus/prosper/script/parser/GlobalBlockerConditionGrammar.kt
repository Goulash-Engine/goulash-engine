...
class GlobalBlockerConditionGrammar : Grammar<GlobalBlockerCondition>() {
    ...
    private val configParser by sectionParser and zeroOrMore(elementParser) map { (section, elements) ->
        mapToGlobalBlockerCondition(section, elements)
    }

    override val rootParser by configParser
